          ...
          {messages.map((m) => (
            <div key={m.id} className="flex gap-4">
              ...
              <div className="flex-1 space-y-2 pt-1">
                ...
                <div className="text-slate-700 leading-relaxed max-w-[85%] prose prose-slate">
                  {/* Basic text rendering, normally you use react-markdown here */}
                  {String((m as any).content || (m as any).text || "").split("\n").map((line: string, i: number) => (
                    <span key={i}>
                      {line}
                      <br />
                    </span>
